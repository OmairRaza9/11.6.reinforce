...
#add a new element to each of the step hash
#add element of person
#loop through the committee and alternatively assign to the new person key

project[:steps].each do |hash|

hash[:person] = project.committee[0]
